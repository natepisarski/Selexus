...
var SelexusEvents = (function () {
    ...
    SelexusEvents.prototype.Activate = function () {
        ...
        $.each(elements, function (index, item) {
            item.insertAdjacentHTML("beforeBegin", '<div class="selexus-popup" id="selexus-ID" style="left: LEFT; top: TOP;">ID</div>'
                .replace("ID", index.toString())
                .replace("LEFT", item.style.left)
                .replace("TOP", item.style.top));
        ...
        $("body").append($('<div class="selexus-entry-field" style="top: TOPpx; left: LEFTpx; height: HEIGHTpx; width: WIDTHpx;"></div>'
            .replace("TOP", y.toString())
            .replace("LEFT", x.toString())
            .replace("HEIGHT", SelexusConstants.HintHeight.toString())
            .replace("WIDTH", SelexusConstants.HintWidth.toString())));
    };
